...
require "required/Security/StaffSecurity.php";


require "required/Need/OrdersSQL.php";
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">        
        <li class="nav-item">
          <a class="nav-link bg-warning" href="indexStaff.php">Home<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link bg-warning" href="staffOrders.php">Orders</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="staffOrders.php" class="list-group-item">All</a>
          <a href="staffOrders.php?pay=COD" class="list-group-item">Via COD(Cash on Delivery)</a>
          <a href="staffOrders.php?pay=GCash" class="list-group-item">Via GCash</a>          
        </div>
      ...
      <hr>
        <div class="row">
          ...
          <?php
          require "required/Table/TableofOrders.php";
          ?>
