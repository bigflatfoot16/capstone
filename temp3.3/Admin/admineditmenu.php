...
require "required/Need/EditMenuSQL.php";
?>
...
<!-- Page Content -->
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <hr>
        <h1 class="my-4">My Menu</h1>
        <div class="form-group">
                  <a href="adminedititem.php"><button type="button" class="btn btn-success btn-sm">Add an Item<strong>+</strong></button></a>                   
                  <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#AddMenuCategory" data-any="ads">Add a Category<strong>+</strong></button>   
        </div>
        
        <div class="list-group">
          <?php 
          require "required/Need/EditMenuListCategory.php";
          ?>
        </div>
      ...
      <hr>
        <div class="row">
          <?php
          require "required/Need/EditMenuListItem.php";
          ?>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-light">
        <button type="submit" class="btn btn-outline-success" role="button" style="font-family: cursive;" onclick="return confirm('Are you sure about your new Menu?')">Add</button>
