    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="adminorders.php" class="list-group-item">All</a>
          <a href="adminorders.php?pay=COD" class="list-group-item">Via COD(Cash on Delivery)</a>
          <a href="adminorders.php?pay=GCash" class="list-group-item">Via GCash</a>          
        </div>
