...
<!-- Page Content -->
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <hr>
        <h2 class="my-3">Sales Overview</h2>
        <div>
      ...
      <hr>
        <div class="row">
          <h1>Sales Overview History</h1>
          
          <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css">
          <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/1.5.6/css/buttons.dataTables.min.css">
          <table id="" class="display" style="width:100%" data-show-columns="true">
        <thead>
            <th>Order No</th>
            <th>Customer</th>
            <th>Total Amount</th>
          ...
          <tbody align="center">
          <?php
          require "required/Table/SalesTable.php";
          ?>
          </tbody>
          </table>
