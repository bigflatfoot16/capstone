...
require "required/Need/SQL/SettingsSQL.php";
...
<div class="container" align="center">
    ...
    <div class="row">
      <?php
      require "required/Need/SQL/SettingsShow.php";
      ?>
      <hr>
        <div class="col-lg-5">
        <br>
        ...
        <!-- GCash Column -->
        <div class="card my-4">
          <h4 class="card-header">GCash Settings:
          <p class="lead" style="font-size: 1rem">Edit your GCash settings here.</p></h4>
          <div class="card-body" style="text-align-last: center;">                   
            <div class="form-group col-lg-8-7">
              <label for="inputName">SMS Name</label>
              <input type="text" class="form-control" style="width: 20rem" name="SMSname" placeholder="SMS Name" required="" value="<?php if(isset($sendername)){echo $sendername;} ?>">
            </div>
            <div class="form-group col-lg-8-7">
              <label for="inputName">SMS API Key</label>
              <input type="text" class="form-control" style="width: 20rem" name="SMSapi" placeholder="SMS API Key">
            </div>
            <div class="form-group col-lg-8-7">
              <label for="inputNumber">GCash Number</label>
              <input type="text" class="form-control" style="width: 20rem" name="gcashNum" placeholder="<?php if(isset($gcashnum)){echo $gcashnum;} ?>" required="" maxlength="11" value="<?php if(isset($gcashnum)){echo $gcashnum;} ?>">
            </div>   
            <button type="submit" name="Submit" class="btn btn-primary" data-toggle="modal" data-target="#Thanks" data-any="ads" onclick="return confirm('Are you sure about the new Setting?')">Submit</button>            
          </div>                      
        </div>     
      </div>
      <!-- SMS Column -->
      <div class="col-lg-6">
        ...
        <!-- Side Widget -->
        <div class="card my-4" >
          <h4 class="card-header">SMS Settings<p class="lead" style="font-size: 1rem">Test your SMS settings here.</p></h4>
          <div class="card-body" style="text-align-last: center;">
              <div class="form-group col-lg-8-7">                
                <label for="inputName">Test Number:</label>
                <input type="text" class="form-control" style="width: 20rem" name="TestNumber" placeholder="Test Number" required>
              </div>
              <div class="form-group col-lg-8-7" >
                <label for="inputName">Text Message:</label><br>
                <textarea  cols='50' rows='8' name="TestMess" placeholder="Test Message"></textarea>
              </div>    
                <button type="submit" name="TestSubmit" class="btn btn-primary" data-toggle="modal" data-target="#Thanks" data-any="ads" onclick="return confirm('Are you sure about SMS your about to send?')">Send</button>        
          </div>      
        </div>
      </div> 
    </div>
