...
require "../Admin/required/Need/addtocart.php";
?>
...
<!-- Page Content -->
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <hr>
        <h1 class="my-4" style="font-size: 30px">Menu Categories</h1>
        <div class="list-group">
         <a href="usermenu.php" class="list-group-item">All</a>
          <?php
          require "../Admin/required/Need/categoryshow.php";
          ?>
        </div>
      ...
      <div class="col-lg-9">
        <hr>
        <h5 style="font-family: cursive;font-size: 25px">Our Best Sellers for this Week</h5>
      ...
      <div class="carousel-item" data-interval="3000"  style="background-image: url('../images/5.jpg')">
        ...
        <div class="row">
          <?php
          require "../Admin/required/Need/usermenushow.php";
          ?>
