    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown dmenu">
          <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">User Controls</a>
          <div class="dropdown-menu sm-menu">
            <a class="dropdown-item" href="useraccounts.php">Edit My Account</a>
            <a class="dropdown-item" href="userorders.php">My Orders</a>
            <a class="dropdown-item" href="usertransact.php">Transaction History</a>
            <a class="dropdown-item" href="userReview.php">Locate Us/Leave a Comment</a><br>
          </div>
        </li>    
        <li class="nav-item">
